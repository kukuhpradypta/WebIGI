    ...
    <main id="main">
            ...
            <div class="container-fluid">
                <div class="row no-gutters">
                    <div class="col-lg-3 col-md-6 content-item">
                        <div class="bg-primary col-12 py-2 ps-3 text-light mb-2 ">kategori 1</div>

                        <div class="row d-flex justify-content-center  flex-wrap" data-aos="zoom-in"
                            data-aos-delay="100">
                            <div class="ani bg-light col-md-6 col-lg-4 col-10 mb-2 shadow "
                                style="width: 100%; border-radius:10px;">
                                <a class="card-petugas" href="">
                                    <div class="row">
                                        <div class="col-4 mt-3 mb-3">
                                            <img src="{{ asset('template/assets/img/team/team-1.jpg') }}"
                    ...
                    <div class="col-lg-3 col-md-6 content-item">
                        <div class="bg-primary col-12 py-2 ps-3 text-light mb-2 ">kategori 2</div>
        ...
        <section id="why-us" class="why-us">
            <div class="container-fluid">
                <div class="row no-gutters">
                    <div class="col-lg-3 col-md-6 content-item">
                        <div class="bg-primary col-12 py-2 ps-3 text-light ">kategori 3</div>
                    ...
                    <div class="col-lg-6 col-md-6  content-item">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('template/assets/img/team/team-1.jpg') }}" width="80%" height="300px"
                                alt="">
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 content-item">
                        <div class="bg-primary col-12 py-2 ps-3 text-light ">Instagram</div>
                        <a href=""><img src="{{ asset('template/assets/img/team/instagram.png') }}"
                                class="mt-2" alt="" width="100%" height="400px"></a>
